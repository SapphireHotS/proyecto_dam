...
public class FrameMesas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/btn_volver_mesas.jpg"))); // NOI18N
        ...
        panelMesas.setLayout(new java.awt.GridLayout(0, 3));
    ...
    private void cargarMesas(){
        try{
                ...
                while(rss.next()) {
                    ...
                    if(ocupada){
                        colocarLabel(label,x,y,iconOcupada,String.format("Mesa %d",mesa), panelMesas);
                    }else{
                        colocarLabel(label,x,y,iconLibre,String.format("Mesa %d",mesa), panelMesas);
                    }
                    valoresX++;
    ...
    private void colocarLabel(JLabel label, int valorX, int valorY, ImageIcon icono, String nombre, JPanel panel) {
